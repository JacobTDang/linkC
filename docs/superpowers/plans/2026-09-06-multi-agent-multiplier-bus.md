...
- [x] **Step 1: Write failing tests for `BlackboardStore`**
...
- [x] **Step 3: Implement `BlackboardModels` and `BlackboardStore`**
...
- [x] **Step 1: Write failing tests for `MCPServer`**
...
- [x] **Step 3: Implement `MCPProtocol` and `MCPServer`**
...
- [x] **Step 1: Write failing tests for `MCPRegistrar`**
...
- [x] **Step 3: Implement `MCPRegistrar` and `linkc-mcp/main.swift`**
...
- [x] **Step 1: Write failing tests for swarm detection**
...
- [x] **Step 3: Implement Swarm Tracking in `AppCoordinator`**
...
- [x] **Step 1: Implement `SwarmBadge` and `CollisionBanner`**
